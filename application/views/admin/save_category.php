...
<div class="container-fluid">
    <div class="row-fluid">
        <form action="<?php echo base_url();?>super_admin/save_category" enctype="multipart/form-data" method="post">
...
//                            }
                    ...
                    <div id="user_registration">
                        ...
                        <p>
                            ...
                            <input class="right_label" type="text" required="1" name="category_name">
                            <span class="imp">*</span>
                        </p>

                        <p>
                            <span class="left_label_width">Category Description</span>
                            <textarea class="right_label" cols="5" rows="2" name="category_description"></textarea>
                            <span class="imp">*</span>
                        </p>
                        <p>
